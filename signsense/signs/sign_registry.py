...
SIGN_REGISTRY: List[SignEntry] = [
    ...
    SignEntry("K", SignType.STATIC,  "Index + middle up, thumb between",  enabled=False),
    SignEntry("L", SignType.STATIC,  "Index up, thumb sideways L shape",  enabled=False),
    SignEntry("M", SignType.STATIC,  "Three fingers over tucked thumb",   enabled=False),
    SignEntry("N", SignType.STATIC,  "Two fingers over tucked thumb",     enabled=False),
    SignEntry("O", SignType.STATIC,  "All fingers circle to thumb",       enabled=False),
    SignEntry("P", SignType.STATIC,  "Like K but pointing down",          enabled=False),
